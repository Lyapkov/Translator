...
import com.lyapkov.model.data.Meanings
...
fun mapHistoryEntityToSearchResult(list: List<com.lyapkov.repository.room.HistoryEntity>): List<DataModel> {
...
fun convertDataModelSuccessToEntity(appState: AppState): com.lyapkov.repository.room.HistoryEntity? {
    return when (appState) {
        is AppState.Success -> {
            ...
            if (searchResult.isNullOrEmpty() || searchResult[0].text.isNullOrEmpty()) {
                ...
                com.lyapkov.repository.room.HistoryEntity(searchResult[0].text!!, null)
            }
        }
        else -> null
    }
